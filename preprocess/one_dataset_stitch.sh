...
#DIR=${output_root_folder}"/"${image_input_folder}
#if [ -d "$DIR" ]; then
#  # Take action if $DIR exists. #
#  echo "dir exists: ${DIR}"
#else
...
python stitching.py --image_dir=${root_input_folder}  --output_dir=${output_root_folder}

#DIR=${output_root_folder}"/"${mask_input_folder}
#if [ -d "$DIR" ]; then
#  # Take action if $DIR exists. #
#  echo "dir exists: ${DIR}"
#else
...
#fi
#
#python stitching.py --image_dir=${root_input_folder}"/"${mask_input_folder}  --output_dir=${output_root_folder}"/"${mask_input_folder}
